...
RUN apt-get -o Acquire::Check-Valid-Until=false update && \\
    ...
    python3-venv python3-pip qhull-bin singular singular-doc sqlite3 sympow tachyon tar \\
...
# -Dpython.install_env=prefix ensures Python modules go to /usr/local/lib/python3.X/site-packages
...
# Clean up build artifacts and caches to shrink the exported filesystem
