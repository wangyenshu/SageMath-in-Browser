...
emulator.add_listener("serial0-output-byte", function(byte)
{
    ...
    if(!booted && serial_text.includes("sage:"))
    {
        ...
        emulator.serial0_send('import os, gc; os.system("dmesg -n 1; sync; echo 3 >/proc/sys/vm/drop_caches")\n');

    }

    if(booted && !saving && serial_text.includes("sage:"))
    {
        console.error("\n\nSageMath Ready. Saving state...");
        saving = true;
